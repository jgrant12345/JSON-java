...
//              Idea4: For first part: create a current keypath and update that. If that's the same, then we're done
...
//              then the rest will go well
               parse(x, jo, null, XMLParserConfiguration.KEEP_STRINGS,false, "/contact", "contact", false);
